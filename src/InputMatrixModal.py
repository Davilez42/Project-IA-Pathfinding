...
class InputMatrixModal():
    ...
    def openModal(self):
        ...
        self.label = tk.Label(
            self.window, text='Enter the matrix name', font=("default", 12))
        ...
        self.confirm_button = tk.Button(
            self.window, text='Load', background='#bebebe', borderwidth=0, activebackground='#b3b7c0', font=("default", 12), command=self.uploadHandler)
        self.confirm_button.config(width=20, height=3)

        self.abort_button = tk.Button(
            self.window, text='Cancel', background='#bebebe', borderwidth=0, activebackground='#b3b7c0', font=("default", 12), command=self.closeModal)
